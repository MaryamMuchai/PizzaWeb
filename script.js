...
let total = 0;
function Frizzapizza( name,size,crust,topping, total ){
  this.name = name;
  this.size = size;
  this.crust = crust;
...
//size and crust
    ...
    $("button.deliver").click(function(){
      ...
      console.log("Hey you will pay .ksh. "+deliveryamount+" on delivery");
      $("#totalbill").append("The total plus the delivery fee is: "+deliveryamount);
    });
